function Tarjeta({ imagen, titulo, descripcion }) {
  return (
    <div className="ring-4 ring-gray-400 hover:ring-indigo-400 flex-shrink-0 relative group w-80 h-80 rounded-2xl overflow-hidden shadow-xl cursor-pointer">
      
      {/* 1. La Imagen Dinámica */}
      <img 
        src={imagen} 
        alt={titulo} 
