...
function App() {
  return (
    <div>
      ...
      <h1 className="text-4xl font-bold text-gray-800 mb-4 text-center mt-4">
        Pie Review
      </h1>
      
      <div class="overflow-x-auto snap-x flex flex-row items-center mt-4 p-6 bg-gray-100 text-center gap-8">
        <Tarjeta 
          imagen="img/pie3.jpg" 
          titulo="Pie 2025"
